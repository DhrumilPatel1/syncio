...
import StoreDatatable from './components/StoreDatatable';
...
const App = () => {
    ...
    const breadcrumb = [
        ...
        // { path: '/store', parent: 'Stores', label: 'Stores' },
    ...
    const menu = [
        ...
        { separator: true },
        {
            ...
            items: [{ label: 'Stores', icon: 'pi pi-fw pi-link', to: '/store' }]
        },
        { separator: true },
        {
            label: 'Products',
            icon: 'pi pi-fw pi-box',
            items: [{ label: 'Products', icon: 'pi pi-fw pi-box', to: '/products' }]
        },
        { separator: true },
        {
            label: 'Settings',
